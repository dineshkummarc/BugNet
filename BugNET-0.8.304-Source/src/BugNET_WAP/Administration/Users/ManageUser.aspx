    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="always">
        <ContentTemplate>       
                ...
                <p style="margin: 2em 0pt 0pt; border-top: 1px solid rgb(221, 221, 221); padding-top: 5px;">
                    ...
                    &nbsp;
                    <asp:ImageButton runat="server"  ImageUrl="~/Images/lt.gif" CssClass="icon"  AlternateText="<%$ Resources:CommonTerms, Return %>" ID="ImageButton3" OnClick="cmdCancel_Click" />
                    <asp:LinkButton ID="LinkButton3" runat="server" Text="<%$ Resources:CommonTerms, Return %>" OnClick="cmdCancel_Click"/>
                </p>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
