<%@ Page Language="C#" MasterPageFile="~/Shared/FullWidth.master"  Title="<%$ Resources:Administration %>"  AutoEventWireup="true" Inherits="BugNET.Administration.Admin" Codebehind="Admin.aspx.cs" %>
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <div style="width:100%">
        <table width="400" style="margin: 0px auto -1px auto;text-align:left;" cellspacing="15">
            ...
            <tr>
                <td colspan="2" style="text-align:center;padding-left:45px;">
                <asp:Label ID="lblHighSecurity" runat="server" visible="false" Text="<H2>High Security Mode Enabled</H2>High Security Mode has been enabled on the Administration section of this website.<br />Certain settings may not actually be modified when you change them in this area." />
                </td>
            </tr>
        </table>
    </div>
