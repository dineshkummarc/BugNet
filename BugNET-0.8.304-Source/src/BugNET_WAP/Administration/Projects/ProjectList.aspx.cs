	...
	public partial class ProjectList : BasePage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            if (!IsPostBack)
            {
                ...
                if (!ITUser.HasPermission(Convert.ToInt32(Request.QueryString["id"]), Globals.Permission.ADMIN_CREATE_PROJECT.ToString()))
		...
		{ 
			if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem) 
			{
                ...
                lblActive.Text = p.Disabled == true ? GetGlobalResourceObject("CommonTerms", "Yes").ToString() : GetGlobalResourceObject("CommonTerms", "No").ToString();
