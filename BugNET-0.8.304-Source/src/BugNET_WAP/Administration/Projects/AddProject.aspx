<%@ Page language="c#" Inherits="BugNET.Administration.Projects.AddProject" ValidateRequest="false" meta:resourcekey="Page" MasterPageFile="~/Shared/FullWidth.master" Title="Add Project" Codebehind="AddProject.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
	...
	<div style="width:750px;margin-right:10px;padding-top:10px;">
		...
		<div style="float:left">
			<asp:Button Text="<%$ Resources:CommonTerms, Cancel %>"  CssClass="button" CausesValidation="false" runat="server" id="btnCancel" />
		</div>
