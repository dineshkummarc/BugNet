...
<%@ Register TagPrefix="IT" TagName="PickImage" Src="~/UserControls/PickImage.ascx" %>
 <div>
    <h2><asp:literal ID="StatusTitle" runat="Server" Text="<%$ Resources:CommonTerms, Status %>" /></h2>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
		    <asp:DataGrid id="grdStatus" 
			    ...
			    <Columns>
				    ...
				    <asp:TemplateColumn>
					    ...
					    <ItemTemplate>
						    <asp:Button id="btnDelete" CommandName="delete" Text="<%$ Resources:CommonTerms, Delete %>"  ToolTip="<%$ Resources:CommonTerms, Delete %>"
							    runat="Server" />
					    </ItemTemplate>
				    </asp:TemplateColumn>
			    </Columns>
            ...
            <div class="fieldgroup">                     
                ...
                <ol>   
                    <li> 
                        <asp:label ID="StatusNameLabel" AssociatedControlID="txtName" runat="Server" Text="<%$ Resources:CommonTerms, Name %>"   />
