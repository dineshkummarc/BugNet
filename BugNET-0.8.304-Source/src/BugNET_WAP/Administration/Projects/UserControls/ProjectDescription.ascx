...
<div>
    <asp:ValidationSummary ID="ValidationSummary1" runat="server"  DisplayMode="BulletList"  CssClass="errors" />
	<h2>Details</h2>
	 ...
	 <div class="fieldgroup" style="border:none">  
        <ol>
            <li>
                ...
                <asp:RequiredFieldValidator Text="<%$ Resources:CommonTerms, Required %>" 
            ...
            <li>
                <asp:Label ID="Label2" AssociatedControlID="ProjectDescriptionHtmlEditor" meta:resourcekey="Description" 
                    ...
                    <asp:RequiredFieldValidator Text="<%$ Resources:CommonTerms, Required %>" ErrorMessage="Description is required"  Display="Dynamic"
           ...
           <li>       
            ...
            <li>
                ...
                <asp:RequiredFieldValidator Text="<%$ Resources:CommonTerms, Required %>" InitialValue="" 
            ...
            <li>
             ...
             <li>
                ...
                <div style="margin:1em 0 0 11em;width:100px;text-align:center;">
