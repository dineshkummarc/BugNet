	...
	public partial class ProjectRoles : System.Web.UI.UserControl, IEditProjectControl
	{
        ...
        protected void cmdAddUpdateRole_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    lblError.Text = Logging.GetErrorMessageResource("AddRoleError");
                }
            }	
        }
        /// <summary>
        ...
        private void UpdatePermissions(int roleId)
        {
            ...
            if (chkAddSubIssue.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.ADD_SUB_ISSUE); else Role.DeleteRolePermission(roleId,(int)Globals.Permission.ADD_SUB_ISSUE);
            if (chkAddParentIssue.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.ADD_PARENT_ISSUE); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.ADD_PARENT_ISSUE);

            //edits
            if (chkEditProject.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.ADMIN_EDIT_PROJECT); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.ADMIN_EDIT_PROJECT);
            if (chkDeleteProject.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.ADMIN_DELETE_PROJECT); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.ADMIN_DELETE_PROJECT);            
            if (chkCloneProject.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.ADMIN_CLONE_PROJECT); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.ADMIN_CLONE_PROJECT);
            if (chkCreateProject.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.ADMIN_CREATE_PROJECT); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.ADMIN_CREATE_PROJECT);
            if (chkViewProjectCalendar.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.VIEW_PROJECT_CALENDAR); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.VIEW_PROJECT_CALENDAR);
            if (chkChangeIssueStatus.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.CHANGE_ISSUE_STATUS); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.CHANGE_ISSUE_STATUS);
            if (chkEditQuery.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.EDIT_QUERY); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.EDIT_QUERY);
            ...
            if (chkDeleteParentIssue.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.DELETE_PARENT_ISSUE); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.DELETE_PARENT_ISSUE);
            if (chkDeleteSubIssue.Checked) Role.AddRolePermission(roleId, (int)Globals.Permission.DELETE_SUB_ISSUE); else Role.DeleteRolePermission(roleId, (int)Globals.Permission.DELETE_SUB_ISSUE);
        ...
        protected void cmdDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = Logging.GetErrorMessageResource("DeleteRoleError"); 
            }
        }
	}
}
