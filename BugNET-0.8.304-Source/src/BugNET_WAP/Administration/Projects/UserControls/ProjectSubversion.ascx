...
<div>
   ...
   <div class="fieldgroup">  
	    ...
	    <ol>
            ...
            <li>
                <asp:Label ID="Label2" CssClass="col1" AssociatedControlID="tagUserName" runat="server" Text="<%$ Resources:CommonTerms, Username %>" />
                <asp:TextBox id="tagUserName" Columns="30" runat="Server" />
            </li>
            <li>
                <asp:Label ID="Label7" CssClass="col1" AssociatedControlID="tagPassword" runat="server" Text="<%$ Resources:CommonTerms, Password %>" />
