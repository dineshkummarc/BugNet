namespace BugNET.Administration.Projects.UserControls
{
	...
	public partial class ProjectStatus : System.Web.UI.UserControl, IEditProjectControl
	{
		...
		void BindStatus() 
		{
            ...
            grdStatus.Columns[1].HeaderText = GetGlobalResourceObject("CommonTerms", "Status").ToString();
            grdStatus.Columns[2].HeaderText = GetGlobalResourceObject("CommonTerms", "Image").ToString();
            grdStatus.Columns[3].HeaderText = GetLocalResourceObject("IsClosedState.Text").ToString();
            grdStatus.Columns[4].HeaderText = GetGlobalResourceObject("CommonTerms", "Order").ToString();
		...
		void DeleteStatus(Object s, DataGridCommandEventArgs e) 
		{
			...
			if (!Status.DeleteStatus(statusId))
                lblError.Text = Logging.GetErrorMessageResource("DeleteStatusError");
			else
				BindStatus();
