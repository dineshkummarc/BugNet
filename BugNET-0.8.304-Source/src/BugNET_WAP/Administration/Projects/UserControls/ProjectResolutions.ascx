     ...
     <ContentTemplate>
	    <asp:DataGrid id="grdResolutions" SkinID="DataGrid"
	        ...
	        width="100%" Runat="Server">
			    <Columns>
			        <asp:editcommandcolumn ItemStyle-Width="100px" edittext="<%$ Resources:CommonTerms, Edit %>"  canceltext="<%$ Resources:CommonTerms, Cancel %>" updatetext="<%$ Resources:CommonTerms, Update %>" ButtonType="PushButton" ItemStyle-Wrap="false"  />
            ...
            <div class="fieldgroup">  
                ...
                <ol>
                    <li>
                        <asp:label ID="ResolutionNameLabel" AssociatedControlID="txtName" runat="Server" Text="<%$ Resources:CommonTerms, Name %>" />
