...
namespace BugNET.UserInterfaceLayer
{
    ...
    public class BasePage : System.Web.UI.Page
    {
        ...
        {
            base.OnLoad(e);
            Page.Title = string.Format("{0} - {1}", Page.Title, HostSetting.GetHostSetting("ApplicationTitle"));
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            else if (Request.QueryString["pid"] != null)
            {
                ...
                Project myProj = Project.GetProjectById(ProjectId);
                ...
                else if (User.Identity.IsAuthenticated && myProj.AccessType == Globals.ProjectAccessType.Private && !Project.IsUserProjectMember(User.Identity.Name, ProjectId))
                {
                    ErrorRedirector.TransferToLoginPage(Page);
                }
            }
