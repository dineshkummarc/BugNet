...
namespace BugNET.BusinessLogicLayer
{
    public class NotificationContext : INotificationContext
    {
        ...
        public NotificationContext(string username, string subject, string bodyText) : this()
        {
        ...
        public NotificationContext(string username, string subject, string bodyText, EmailFormatTypes emailFormatType)
        ...
        public NotificationContext(string username, string subject, string bodyText, EmailFormatTypes emailFormatType, string userDisplayName)
        ...
        public EmailFormatTypes EmailFormatType { get; set; }
