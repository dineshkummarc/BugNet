...
namespace BugNET.BusinessLogicLayer
{
	...
	public class Role
	{
		#region Private Variables
            private const string ROLE_PERMISSION = "RolePermission";
			private int _Id;
		...
		#region Static Methods
			...
			public static void AddUserToRole(string userName,int roleId)
			{
                ...
                HttpContext.Current.Cache.Remove(ROLE_PERMISSION);
			}
			...
			public static List<RolePermission> GetRolePermissions()
			{
				...
				if(permissions == null)
				{
                    ...
                    HttpContext.Current.Cache.Insert(ROLE_PERMISSION, permissions);
				}
				return permissions;
