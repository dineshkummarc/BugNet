...
namespace BugNET.BusinessLogicLayer
{
    ...
    public class ITUser : IToXml
    {
        ...
        /// <summary>
        /// Determines whether [is in role] [the specified user name] [the specified projectid].
        /// </summary>
        /// <param name="userName">Name of the user.</param>
        /// <param name="projectId">The project id.</param>
        /// <param name="roleName">Name of the role.</param>
        /// <returns>
        /// 	<c>true</c> if [is in role] [the specified user name] [the specified projectid]; otherwise, <c>false</c>.
        /// </returns>
        ...
        public static bool IsInRole(string userName, string roleName)
        {
            ...
            List<Role> roles = Role.GetRolesForUser(userName);
        ...
        public static void SendUserNewPasswordNotification(MembershipUser user, string newPassword)
        {
            ...
            //load template and replace the tokens
            string template = nm.LoadEmailNotificationTemplate("PasswordReset");
            string subject = nm.LoadNotificationTemplate("PasswordResetSubject");
            string displayname = ITUser.GetUserDisplayName(user.UserName);
            ...
            nm.SendNotification(user.UserName, subject, template);
        ...
        public static void SendUserRegisteredNotification(string userName)
        {
            ...
            //load template and replace the tokens
            string template = nm.LoadEmailNotificationTemplate("UserRegistered");
