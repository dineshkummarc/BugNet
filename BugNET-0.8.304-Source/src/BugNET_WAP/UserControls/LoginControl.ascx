<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginControl.ascx.cs" Inherits="BugNET.UserControls.LoginControl" %>
    ...
    onload="pnlLoginControl_Load" >
           <asp:Login ID="subLoginControl" runat="server" DestinationPageUrl="~/Default.aspx" 
                ...
                PasswordRecoveryUrl="~/ForgotPassword.aspx" TitleText="Login" 
                                   ...
                                   <tr>
                                       <td align="right" class="label">
                                           <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" 
                                                Text="<%$ Resources:CommonTerms, Username %>">Username:</asp:Label>
                                       </td>
                                       <td>
                                           <asp:TextBox ID="UserName" runat="server" Width="110px"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
                                                ControlToValidate="UserName" 
                                                ErrorMessage="<%$ Resources:CommonTerms, UsernameRequired.ErrorMessage %>" 
                                                meta:resourcekey="UserNameRequired" ToolTip="User Name is required." 
                                   ...
                                   <tr>
                                       <td align="right" class="label">
                                           <asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password" 
                                                Text="<%$ Resources:CommonTerms, Password %>">Password:</asp:Label>
                                       </td>
                                       <td>
