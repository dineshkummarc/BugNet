        ...
        protected void ChangeLogRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (m.ReleaseDate.HasValue)
                {
                    ...
                    ((Label)e.Item.FindControl("lblReleaseDate")).Text = string.Format("Released on {0}", date.ToShortDateString());
                }
                else
                {
                    ((Label)e.Item.FindControl("lblReleaseDate")).Text = "no release date";
                }
                ...
                ((HyperLink)e.Item.FindControl("IssuesCount")).Text = issueList.Count.ToString() + " issues";
