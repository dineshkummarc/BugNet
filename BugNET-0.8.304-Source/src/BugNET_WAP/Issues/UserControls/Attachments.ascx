<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Attachments.ascx.cs" Inherits="BugNET.Issues.UserControls.Attachments" %>
    ...
    <asp:datagrid id="AttachmentsDataGrid" Width="100%" runat="server" 
        ...
        <columns>
            ...
            <asp:boundcolumn datafield="CreatorDisplayName" HeaderText="<%$ Resources:CommonTerms, Creator %>" />
            <asp:boundcolumn HeaderText="<%$ Resources:CommonTerms, Created %>" datafield="DateCreated" DataFormatString="{0:g}" />
            <asp:TemplateColumn>
                <ItemStyle Width="70px" />
                <ItemTemplate>
