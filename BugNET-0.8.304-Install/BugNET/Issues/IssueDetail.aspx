<%@ Page Language="c#" ValidateRequest="false" Inherits="BugNET.Issues.IssueDetail"
    MasterPageFile="~/Shared/Issue.master" Title=" " CodeBehind="IssueDetail.aspx.cs"
        ...
        <div style="float: right; padding-right: 10px;">
            ...
            <span style="padding-right: 5px; padding-left: 10px; border-left: 1px dotted #ccc">
                ...
                <asp:LinkButton ID="LinkButton1" OnClick="CancelButtonClick" CausesValidation="false"
                    runat="server" Text="<%$ Resources:CommonTerms, Cancel %>" />
            </span>
            <span style="padding-left: 10px; padding-right: 5px; border-left: 1px dotted #ccc"
                ...
                <asp:LinkButton ID="lnkDelete" OnClick="lnkDelete_Click" CausesValidation="false"
                    runat="server" Text="<%$ Resources:CommonTerms, Delete %>" />
            </span>
        </div>
                                ...
                                <td style="vertical-align: top;">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:TextBox ID="TitleTextBox" CssClass="issueTitle" Visible="False" Width="95%" runat="server" />
                                            <asp:RequiredFieldValidator
                                                ControlToValidate="TitleTextBox" Text="<%$ Resources:CommonTerms, Required %>"
                                                Display="Dynamic" runat="server" ID="TitleRequired" />
                                            <ajaxToolkit:TextBoxWatermarkExtender ID="TBWE2" runat="server"
                                                TargetControlID="TitleTextBox"
                                                WatermarkText="Enter A Title"
            ...
            <ContentTemplate>
                <p style="margin-top: 8px; padding: 8px 0 8px 0; border-top: 1px solid #CCCCCC; overflow: auto;">
                    <asp:ImageButton ID="EditDescription" Visible="false" CssClass="icon" OnClick="EditDescription_Click"
                        ...
                        runat="server" />&nbsp;<strong><asp:Label ID="DescriptionLabel" runat="server" Text="<%$ Resources:CommonTerms, Description %>"></asp:Label></strong>
                </p>
