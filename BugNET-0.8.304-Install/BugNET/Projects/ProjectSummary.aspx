                    ...
                    <tr>
                        <th colspan="4">
                            <div class="roundedBox">
                                <asp:literal id="Literal1" runat="server"  meta:resourcekey="MilestonesLabel" /> <span class="small"><asp:Literal ID="Literal2" runat="server" meta:resourcekey="OpenIssues"/> </span>
                            </div>
...
<asp:Content ContentPlaceHolderID="centerleftcontent" runat="server" ID="content2">
    <table class="summary">
        <tr>
            <th>
                <div class="roundedBox">
                    <asp:Literal ID="Literal3" runat="server" meta:resourcekey="Categories"/>  <span class="small"><asp:Literal ID="Literal2" runat="server" meta:resourcekey="OpenIssues"/></span>
                </div>
            </th> 
        </tr>
        <tr>
            ...
            <HeaderTemplate>
                <table class="summary" cellspacing="3">
                    <tr>
	                    <th colspan="4">
		                      <div class="roundedBox">
				                  <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CommonTerms, Status %>"/>
		                    </div>
	                    </th> 
                    </tr> 
            </HeaderTemplate> 
            ...
            <HeaderTemplate>
                <table class="summary" cellspacing="3">
                    <tr>
	                    <th colspan="3">
		                   <div class="roundedBox">
				                 <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CommonTerms, Priority %>"/>
		                    </div>
	                    </th> 
                    </tr> 
            </HeaderTemplate> 
            ...
            <HeaderTemplate>
                <table class="summary" cellspacing="3">
                    <tr>
	                    <th colspan="3">
		                    <div class="roundedBox">
				                <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CommonTerms, Type %>" />
		                    </div>
	                    </th> 
                    </tr> 
            </HeaderTemplate> 
