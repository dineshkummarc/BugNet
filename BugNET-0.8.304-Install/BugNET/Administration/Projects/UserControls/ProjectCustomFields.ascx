...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <Columns>   
            <asp:BOUNDCOLUMN visible="False" datafield="Id" headertext="<%$ Resources: CommonTerms, Id %>" />
            ...
            <asp:editcommandcolumn edittext="<%$ Resources:CommonTerms, Edit %>"  canceltext="<%$ Resources:CommonTerms, Cancel %>" updatetext="<%$ Resources:CommonTerms, Update %>" ButtonType="PushButton" />
	        ...
	        <asp:TemplateColumn>
		        ...
		        <ItemTemplate>				     
		            <asp:ImageButton id="btnDelete" ImageUrl="~/images/cross.gif" 
					    AlternateText="<%$ Resources:CommonTerms, Delete %>" 
								...
								<td>
                                    ...
                                    <Columns>
                                          <asp:boundcolumn visible="False" datafield="Id" headertext="ID" />
                                           <asp:editcommandcolumn CausesValidation="true" ValidationGroup="UpdateSelection" edittext="<%$ Resources:CommonTerms, Edit %>"  canceltext="<%$ Resources:CommonTerms, Cancel %>" updatetext="<%$ Resources:CommonTerms, Update %>" ButtonType="PushButton" />
                                          <asp:TemplateColumn HeaderText="Name">
                                            ...
                                            <EditItemTemplate>
                                            	...
                                            	<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Text="<%$ Resources:CommonTerms, Required %>" ControlToValidate="txtEditSelectionName" ValidationGroup="UpdateSelection"></asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                            <FooterTemplate>
												<asp:textbox id="txtAddSelectionName" runat="server" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="<%$ Resources:CommonTerms, Required %>" ControlToValidate="txtAddSelectionName" ValidationGroup="AddSelection"></asp:RequiredFieldValidator>
                                            </FooterTemplate>
                                          </asp:TemplateColumn>
                                           <asp:TemplateColumn HeaderText="<%$ Resources:Value %>">
                                            <ItemTemplate>
                                             ...
                                             <EditItemTemplate>
                                            	...
                                            	<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="<%$ Resources:CommonTerms, Required %>" ControlToValidate="txtEditSelectionValue" ValidationGroup="UpdateSelection"></asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                            <FooterTemplate>
												<asp:textbox id="txtAddSelectionValue" cssclass="textbox" runat="server" />
												<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Text="<%$ Resources:CommonTerms, Required %>" ControlToValidate="txtAddSelectionValue" ValidationGroup="AddSelection"></asp:RequiredFieldValidator>
                                            </FooterTemplate>
                                          </asp:TemplateColumn>
                                          <asp:TemplateColumn HeaderText="<%$ Resources:CommonTerms, Order %>">
							            ...
							            <asp:TemplateColumn>
								            ...
								            <ItemTemplate>
									            <asp:Button id="btnDelete" CommandName="delete" Text="<%$ Resources:CommonTerms, Delete %>" CssClass="standardText" ToolTip="<%$ Resources:CommonTerms, Delete %>"
										            runat="Server" />
								            </ItemTemplate>
								            <FooterTemplate>
								                <asp:Button id="btnAddSelectionValue" ValidationGroup="AddSelection" CommandName="add" Text="<%$ Resources:CommonTerms, Add %>" CssClass="standardText" ToolTip="<%$ Resources:CommonTerms, Add %>"
										            runat="Server" />
								            </FooterTemplate>
							            </asp:TemplateColumn>
