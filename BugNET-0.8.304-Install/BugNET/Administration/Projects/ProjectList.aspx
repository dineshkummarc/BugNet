<%@ Page language="c#" Inherits="BugNET.Administration.Projects.ProjectList"  MasterPageFile="~/Shared/FullWidth.master" meta:resourcekey="Page" Title="Project List" Codebehind="ProjectList.aspx.cs" %>
<asp:Content ContentPlaceHolderID="content" runat="server" ID="Content1">
    ...
    <div style="padding:0px 0 10px 0;">
        ...
        <span id="CloneProject" runat="server">
            ...
            <asp:HyperLink ID="lnkCloneProject" runat="server"  NavigateUrl="~/Administration/Projects/CloneProject.aspx" Text="<%$ Resources:CommonTerms, CloneProject %>"/>
        </span>
    </div>
	<asp:DataGrid id="dgProjects"  Width="100%" SkinID="DataGrid"  AllowSorting="true" runat="server">
		<columns>
			...
			<asp:BoundColumn HeaderText="<%$ Resources:CommonTerms, Description %>" DataField ="Description" SortExpression="Description" />
			<asp:BoundColumn HeaderText="<%$ Resources:ProjectManager %>" DataField="ManagerDisplayName" SortExpression="Manager"/>
			<asp:templatecolumn HeaderText="<%$ Resources:CommonTerms, Created %>" SortExpression="Created">
				<itemtemplate>
