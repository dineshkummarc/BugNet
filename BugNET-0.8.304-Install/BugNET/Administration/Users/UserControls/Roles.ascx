...
<fieldset>
    <legend><asp:Label id="Label1" runat="server" Text="<%$ Resources:CommonTerms, Project %>" /> <bn:PickProject id="dropProjects" CssClass="standardText" DisplayDefault="true"  OnSelectedIndexChanged="ddlProjects_SelectedIndexChanged" AutoPostBack="true" Runat="Server" /></legend> 
...
<p align="center" style="margin-top:15px;">
    ...
    <asp:LinkButton ID="cmdUpdateRoles" runat="server" Text="<%$ Resources:CommonTerms, Update %>" OnClick="cmdUpdateRoles_Click"></asp:LinkButton>
</p>
