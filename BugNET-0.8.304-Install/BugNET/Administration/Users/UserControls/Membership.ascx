...
<div class="fieldgroup">
    ...
    <ol>
        ...
        <li>
            <asp:Label ID="Label5" AssociatedControlID="DisplayName" runat="server" Text="<%$ Resources:CommonTerms, DisplayName %>" />
        ...
        <li>
            <asp:Label ID="Label10" AssociatedControlID="Authorized" runat="server" Text="<%$ Resources:CommonTerms, Authorized %>" />
...
<div class="submit">
    <asp:ImageButton OnClick="cmdUpdate_Click" runat="server" id="save" CssClass="icon" AlternateText="<%$ Resources:CommonTerms, Update %>" ImageUrl="~/Images/disk.gif" />
    <asp:LinkButton ID="cmdUpdate" OnClick="cmdUpdate_Click" runat="server" Text="<%$ Resources:CommonTerms, Update %>"></asp:LinkButton>
    &nbsp;&nbsp;
